 ...
 * @author byron
 */
public class AdministradorDocentes extends javax.swing.JFrame {

    /**
     * Creates new form AdministradorDocentes
     */
    public AdministradorDocentes() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministradorDocentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministradorDocentes().setVisible(true);
            }
        });
    }
