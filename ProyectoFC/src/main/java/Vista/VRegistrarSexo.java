 ...
 * @author MAWIL
 */
public class VRegistrarSexo extends javax.swing.JFrame {

    Conexionbd conexion = new Conexionbd();
    
    public VRegistrarSexo() throws SQLException {
        initComponents();
        setLocationRelativeTo(null);
    }
    
    public void mostrar() throws SQLException{
        //mostrar datos en la tabla sexo
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jbtncrear, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbtncrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtncrearActionPerformed
        // registrar sexo instanciando la clase sexo
        ...
        if(sex.insertar()){
            ...
            try {
                ...
                Logger.getLogger(VRegistrarSexo.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        else
        {
