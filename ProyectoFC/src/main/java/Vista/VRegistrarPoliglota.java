 ...
 * @author MAWIL
 */
public class VRegistrarPoliglota extends javax.swing.JFrame {

    Conexionbd conexion = new Conexionbd();
    
    public VRegistrarPoliglota() throws SQLException {
        initComponents();
        setLocationRelativeTo(null);
    }
    
    public void mostrar() throws SQLException{
        //mostrar datos en la tabla poliglota
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jbtncrear, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                .addComponent(jbtsalir, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel1.setText("POLIGLOTA CREAR ");
    ...
    private void jbtncrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtncrearActionPerformed
        // registrar poliglota instanciando la clase poliglota
        ...
        if(pol.insertar()){
            ...
            try {
                ...
                Logger.getLogger(VRegistrarPoliglota.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        else
        {
